export interface IllustrationSignupMobileProps {}

export default function IllustrationSignupMobile({}: IllustrationSignupMobileProps) {
  return (
    <div className="">
      <svg
      ...
      >
        <defs>
          <linearGradient id="b" x1="100%" x2="0%" y1="21.322%" y2="78.678%">
            ...
            <stop offset="100%" stop-color="#FF527B"></stop>
          </linearGradient>
          <linearGradient
            id="h"
            x1="22.319%"
          ...
          >
            ...
            <stop offset="100%" stop-color="#FF9F2E"></stop>
          </linearGradient>
          <linearGradient id="k" x1="50%" x2="50%" y1="0%" y2="100%">
            <stop offset="0%" stop-color="#FFB443"></stop>
            <stop offset="100%" stop-color="#FF5B64" stopOpacity="0"></stop>
          </linearGradient>
          ...
          <linearGradient id="p" x1="50%" x2="50%" y1="0%" y2="100%">
            <stop offset="0%" stop-color="#CACBE8"></stop>
            <stop offset="100%" stop-color="#EEE"></stop>
            <stop offset="100%" stop-color="#CACBE8"></stop>
          </linearGradient>
          <linearGradient
            id="r"
            x1="97.791%"
          ...
          <linearGradient id="t" x1="50%" x2="50%" y1="0%" y2="100%">
            ...
            <stop offset="100%" stop-color="#FF5B66"></stop>
          </linearGradient>
          <path
            id="a"
        ...
        <g fill="none" fill-rule="evenodd">
          ...
          <g mask="url(#c)">
            <g fill-rule="nonzero" transform="translate(-16 87.784)">
              <use xlinkHref="#e" fill="#000" filter="url(#d)"></use>
              <use xlinkHref="#e" fill="#242742"></use>
            </g>
            <g transform="translate(-7.351 95.892)">
              <g fill-rule="nonzero">
                <use xlinkHref="#g" fill="#000" filter="url(#f)"></use>
                <use xlinkHref="#g" fill="url(#h)"></use>
              </g>
              <mask id="l" fill="#fff">
                <use xlinkHref="#i"></use>
              </mask>
              <g fill-rule="nonzero">
                <use xlinkHref="#i" fill="#000" filter="url(#j)"></use>
                <use xlinkHref="#i" fill="url(#h)"></use>
              </g>
              <circle
                cx="210.81"
                cy="131.892"
            ...
            <g fill-rule="nonzero" transform="translate(157.513 35.892)">
              <use xlinkHref="#n" fill="#000" filter="url(#m)"></use>
              <use xlinkHref="#n" fill="url(#o)"></use>
              <path
                fill="url(#p)"
            ...
            <g transform="translate(220.757 24)">
              ...
              <use xlinkHref="#q" fill="#FFF" fill-rule="nonzero"></use>
              <path
                fill="url(#r)"
                fill-rule="nonzero"
